...
class ImageManager
{
     ...
     * @param  string|null  $format  Specify an image format/extension.
     * @return string
     */
     ...
     *
     * @param  bool  $fromRoot  If true, returns the fully qualified path. If false, returns the public path to the image.
     * @throws \Exception
     * @return string
     */
    ...
    /** 
     * Set $this->image as an alias of $this->temp, then unset $this->temp.
     */
    ...
    /** 
     * Convert the image and to the server.
     *
     * @param  string  $format
     */
